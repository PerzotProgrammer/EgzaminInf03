...
<body>
    ...
    <section id="lMain">
        <img src="american.jpg" alt="Świnka morska rasy american">
            <?php
            $query = "SELECT DISTINCT data_ur, miot, rasa FROM swinki INNER JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id = 6;";
        ...
        <h2>Świnki w tym miocie</h2>
            <?php
            $query = "SELECT imie, cena, opis FROM swinki WHERE id = 6;";
