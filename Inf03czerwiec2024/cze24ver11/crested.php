...
<body>
    ...
    <section id="lMain">
        <img src="crested.jpg" alt="Świnka morska rasy crested">
            <?php
            $query = "SELECT DISTINCT data_ur, miot, rasa FROM swinki INNER JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id = 7;";
        ...
        <h2>Świnki w tym miocie</h2>
            <?php
            $query = "SELECT imie, cena, opis FROM swinki WHERE id = 7;";
